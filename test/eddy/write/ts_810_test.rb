...
module WriteTest
  class TS810Test < Minitest::Test
    ...
    def test_nested_loops
      ...
      ts.DTM.DTM01 = "011"
      ts.DTM.DTM02 = @epoch
      ts.L_IT1.repeat do |rep|
        # IT1
        rep.IT1.AssignedIdentification = "1"
        rep.IT1.QuantityInvoiced = 1
        rep.IT1.IT103 = "EA"
        rep.IT1.UnitPrice = 59.95
        rep.IT1.IT106 = "UP"
        ...
        rep.L_PID.repeat do |rep|
          rep.PID.PID01 = "F"
          rep.PID.PID05 = "CBD Topical Cream 400mg THC Free"
        end
        # SAC
        rep.L_SAC.repeat do |rep|
          rep.SAC.SAC01 = "C"
          rep.SAC.SAC02 = "ZZZZ"
          rep.SAC.SAC05 = 0
        end
