  ...
  module Segments
    ...
    class IT1 < Eddy::Segment
      ...
      def initialize(store)
        @id = "IT1"
        @name = "Baseline Item Data (Invoice)"
        @it101 = Eddy::Elements::E350.new(req: "O")
        @it102 = Eddy::Elements::E358.new(req: "X")
        @it103 = Eddy::Elements::E355.new(req: "X")
        @it104 = Eddy::Elements::E212.new(req: "X")
        @it105 = Eddy::Elements::E639.new(req: "O")
        @it106 = Eddy::Elements::E235.new(req: "X")
        @it107 = Eddy::Elements::E234.new(req: "X")
        @it108 = Eddy::Elements::E235.new(req: "X")
        @it109 = Eddy::Elements::E234.new(req: "X")
        @it110 = Eddy::Elements::E235.new(req: "X")
        @it111 = Eddy::Elements::E234.new(req: "X")
        @it112 = Eddy::Elements::E235.new(req: "X")
        @it113 = Eddy::Elements::E234.new(req: "X")
        @it114 = Eddy::Elements::E235.new(req: "X")
        @it115 = Eddy::Elements::E234.new(req: "X")
        super(
          store,
          @it101,
          @it102,
